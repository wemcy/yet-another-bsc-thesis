...
- The system should update the user's existing rating if they rate the same recipe again.
- The system should allow administrators to edit or delete comments.
