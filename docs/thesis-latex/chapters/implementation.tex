...
A könnyű fejlesztés érdekében a legtöbb gyakran használt parancs, mint például a build, a tesztelés, vagy a konténeres futtatás, PowerShell szkriptek segítségével van automatizálva, amelyek a repository gyökerében találhatók.
\subsection{Backend}
