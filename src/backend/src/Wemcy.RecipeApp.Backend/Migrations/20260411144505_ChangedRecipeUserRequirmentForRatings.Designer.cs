...
namespace Wemcy.RecipeApp.Backend.Migrations
{
    ...
    [Migration("20260411144505_ChangedRecipeUserRequirmentForRatings")]
    partial class ChangedRecipeUserRequirmentForRatings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wemcy.RecipeApp.Backend.Model.Comment", b =>
                {
                    ...
                    b.HasOne("Wemcy.RecipeApp.Backend.Model.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
