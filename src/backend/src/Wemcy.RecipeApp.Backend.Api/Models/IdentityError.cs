...
{ 
    ...
    /// </summary>
    [DataContract]
    public class IdentityError : IEquatable<IdentityError>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((IdentityError)obj);
        }

        /// <summary>
        /// Returns true if IdentityError instances are equal
        /// </summary>
        /// <param name="other">Instance of IdentityError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityError other)
        {
